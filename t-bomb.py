...
def bann_text():
   ...
   ▒▒▒██▒▒▒ ██▒▒██                ██
    ...
    contributors = "Developed by Rayhan"
    print(random.choice(ALL_COLORS) + logo + RESET_ALL)
    mesgdcrt.SuccessMessage("T-Bomb by Rayhan")
...
def do_zip_update():
    success = False
    if DEBUG_MODE:
        zip_url = "https://github.com/rayhankhan4u/T-Bomb/archive/dev.zip"
        dir_name = "T-Bomb-dev"
    else:
        zip_url = "https://github.com/rayhankhan4u/T-Bomb/archive/main.zip"
        dir_name = "T-Bomb-main"
    ...
    if success:
        mesgdcrt.SuccessMessage("T-Bomb by Rayhan was updated to the latest version")
        mesgdcrt.GeneralMessage(
            "Please run the script again to load the latest version")
    else:
        mesgdcrt.FailureMessage("Unable to update T-Bomb by Rayhan.")
        mesgdcrt.WarningMessage(
            "Grab The Latest one From https://github.com/rayhankhan4u/T-Bomb.git")
...
def do_git_update():
    ...
    try:
        ...
        process = subprocess.Popen("git checkout . && git pull https://github.com/rayhankhan4u/T-Bomb.git main",
                                   shell=True,
    ...
    if success:
        ...
        print(
            "git checkout . && "
            "git pull https://github.com/rayhankhan4u/T-Bomb.git main")
    sys.exit()
...
def check_for_updates():
    ...
    fver = requests.get(
        "https://raw.githubusercontent.com/rayhankhan4u/T-Bomb/main/.version"
    ).text.strip()
    if fver != __VERSION__:
        ...
        mesgdcrt.SuccessMessage("T-Bomb by Rayhan is up-to-date")
        mesgdcrt.GeneralMessage("Starting T-Bomb by Rayhan")


def notifyen():
    try:
        if DEBUG_MODE:
            url = "https://github.com/rayhankhan4u/T-Bomb/raw/dev/.notify"
        else:
            url = "https://github.com/rayhankhan4u/T-Bomb/raw/main/.notify"
...
def pretty_print(cc, target, success, failed):
    ...
    mesgdcrt.SuccessMessage("T-Bomb by Rayhan was created by Rayhan")
...
if sys.version_info[0] != 3:
    mesgdcrt.FailureMessage("T-Bomb by Rayhan will work only in Python v3")
    sys.exit()
...
description = """T-Bomb by Rayhan - Your Friendly Spammer Application

T-Bomb by Rayhan can be used for many purposes which includes -
\t Exposing the vulnerable APIs over Internet
\t Friendly Spamming
\t Testing Your Spam Detector and more ....

T-Bomb by Rayhan is not intended for malicious uses.
"""

parser = argparse.ArgumentParser(description=description,
                                 epilog='Coded by Rayhan !!!')
parser.add_argument("-sms", "--sms", action="store_true",
                    help="start T-Bomb by Rayhan with SMS Bomb mode")
parser.add_argument("-call", "--call", action="store_true",
                    help="start T-Bomb by Rayhan with CALL Bomb mode")
parser.add_argument("-mail", "--mail", action="store_true",
                    help="start T-Bomb by Rayhan with MAIL Bomb mode")
parser.add_argument("-ascii", "--ascii", action="store_true",
                    help="show only characters of standard ASCII set")
parser.add_argument("-u", "--update", action="store_true",
                    help="update T-Bomb by Rayhan")
parser.add_argument("-c", "--contributors", action="store_true",
                    help="show current T-Bomb by Rayhan contributors")
parser.add_argument("-v", "--version", action="store_true",
                    help="show current T-Bomb by Rayhan version")

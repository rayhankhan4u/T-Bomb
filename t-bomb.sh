...
banner() {
    ...
    if ! [ -x "$(command -v figlet)" ]; then
        echo 'Introducing T-Bomb'
    else
        figlet T-Bomb
    fi
    if ! [ -x "$(command -v toilet)" ]; then
        echo -e "\e[4;34m This Bomber Was Created By \e[1;32mRayhan \e[0m"
    else
        echo -e "\e[1;34mCreated By \e[1;34m"
        toilet -f mono12 -F border Rayhan
    fi
    echo -e "\e[1;34m Developed by Rayhan for educational purposes \e[0m"
    echo " "
    echo "NOTE: Kindly move to the PIP version Of T-Bomb for more stability."
    echo " "
}
...
if [ -f .update ];then
    ...
    echo .
    install_deps
    echo This Script Was Made By Rayhan > .update
...
do
    ...
    if [ $ch -eq 1 ];then
        ...
        echo -e "\e[1;34m RUN T-Bomb Again..."
        pause
        exit
    elif [ $ch -eq 5 ];then
        banner
